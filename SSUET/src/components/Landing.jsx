    ...
    <ThemeProvider theme={theme}>
      ...
      <Navbar position="fixed" isTransparent={navbarTransparent}>
        ...
        <FullHeightSection id="section1" ref={(el) => (sectionRefs.current[0] = el)}>
          <TextBox>Welcome to Section 1</TextBox>
        </FullHeightSection>
          ...
          <SectionContent>
            ...
            >
              ...
              >
                <ImageWrapper>
                  <img
                    src={id === "section2" ? "/section1.jpg" : "/recycle.jpg"}
                    alt={`Section ${index + 2}`}
                    style={{ width: "100%" }}
                  />
                </ImageWrapper>
              ...
              <Grid item xs={12} md={6}>
                ...
                >
                  {id === "section2" ? "Donations" : "Sustaianable Discards"}
                </Typography>
                <Typography sx={{ fontSize: "1.6rem", color: "#2b6777" }}>
                  {id === "section2" ? "Our Rewear app connects donors with people in need, making it easier to contribute to causes like hunger, education, and healthcare. It simplifies the donation process, ensuring every contribution directly benefits those in need, fostering a more compassionate and equitable world!" : "Our app also leverages Gen AI to suggest sustainable ways to reuse discarded materials, helping users reduce waste and contribute to a more eco-friendly environment. By offering creative solutions for repurposing everyday items, we empower individuals to make environmentally conscious decisions while promoting sustainability in their communities"} 
                </Typography>
              </Grid>
            </Grid>
          </SectionContent>
...
>
  <SectionContent>
    ...
    <Grid container spacing={4}>
      {["NGOs can efficiently add and manage the details of deserving individuals using Excel, ensuring that help reaches those who need it most.","The app allows NGOs to track student progress and engagement with various programs, ensuring that educational resources are effectively utilized.","The app promotes sustainable practices by offering guidance on reusing discarded materials, helping both the community and the environment. see more features by singup to our app",].map((box, index) => (
